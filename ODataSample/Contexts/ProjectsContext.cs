...
namespace ODataSample.Contexts
{
    ...
    public class ProjectDBInitializer : DropCreateDatabaseAlways<ProjectsContext>
    {
        ...
        protected override void Seed(ProjectsContext context)
        {
            ...
            {
                new Language { Description = "Spanish", IsActive = true, Id = 1, Name = "es" },
                new Language { Description = "English", IsActive = true, Id = 2, Name = "en" }
            });

            context.ProjectStatuses.AddRange(new[]
            {
                new ProjectStatus { Id=1, Name="Active", Description="Active", IsActive= true },
                new ProjectStatus { Id=2, Name="Closed", Description="Closed", IsActive= true },
                new ProjectStatus { Id=3, Name="InProgress", Description="In Progress", IsActive= true }
            });

            context.ProjectStatusTexts.AddRange(new[]
            {
                new ProjectStatusText {Id = 1, LanguageId=1,  Name = Path.GetRandomFileName(),Description = Path.GetRandomFileName(),IsActive=true },
                new ProjectStatusText {Id = 2, LanguageId=2, Name = "Active",Description = "Active",IsActive=true },
                new ProjectStatusText {Id = 3, LanguageId=1, Name = Path.GetRandomFileName(),Description = Path.GetRandomFileName(),IsActive=true },
                new ProjectStatusText {Id = 4, LanguageId=2, Name = "Active",Description = "Active",IsActive=true }
            });
